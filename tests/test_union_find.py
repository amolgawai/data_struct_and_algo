...
from coursera_algo1.union_find import QuickFindUF, QuickUnionUF, UnionFind
...
def test_quickfind_uf(get_test_data_path):
...
def test_quickunion_uf(get_test_data_path):
